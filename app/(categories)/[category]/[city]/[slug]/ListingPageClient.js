  ...
  return (
    <>
      ...
      {related.length > 0 && (
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {related.map((item) => (
              <Link key={item.slug} href={`/${categorySlug}/${item.citySlug}/${item.slug}`} className="group no-underline">
      ...
      <div className="text-center mt-12 mb-8">
        <Link href={`/${categorySlug}`} className="inline-flex items-center gap-2 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 font-bold transition-all hover:gap-3 no-underline group text-sm md:text-base">
