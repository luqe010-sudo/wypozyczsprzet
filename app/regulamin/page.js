      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="p-8 md:p-12">
            <h1 className="text-3xl font-extrabold text-gray-900 mb-8 text-center">📄 REGULAMIN SERWISU „WYPOŻYCZ SPRZĘT”</h1>
            ...
            <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§3. Zasady korzystania z serwisu</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§4. Dodawanie ogłoszeń</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§5. Odpowiedzialność użytkownika</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§6. Publikacja i czas trwania ogłoszeń</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§7. Płatności (opcjonalnie – na przyszłość)</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§8. Dane kontaktowe</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§9. Ochrona danych osobowych</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§10. Zmiany regulaminu</h2>
                <ol className="list-decimal pl-5 space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-gray-900 mb-3">§11. Postanowienia końcowe</h2>
                <ol className="list-decimal pl-5 space-y-2">
