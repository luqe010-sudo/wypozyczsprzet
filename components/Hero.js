        ...
        <div className="w-full max-w-4xl bg-white p-2 md:p-3 rounded-2xl md:rounded-full shadow-2xl flex flex-col md:flex-row items-center gap-3 md:gap-0">
          ...
          <div className="flex-1 w-full flex items-center px-4 py-3 md:py-2 border-b md:border-b-0 md:border-r border-gray-200">
            ...
            <div className="flex flex-col flex-1 text-left">
              ...
              <select className="w-full text-gray-900 outline-none bg-transparent font-medium cursor-pointer appearance-none">
                <option value="">Wszystkie miasta</option>
                {/* City options would be passed as props in a real implementation if needed here, but standard is sidebar */}
              </select>
            </div>
          ...
          {/* CTA Button */}
          <button className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 md:py-4 px-8 rounded-xl md:rounded-full transition-all duration-200 flex items-center justify-center whitespace-nowrap shadow-md mt-2 md:mt-0">
