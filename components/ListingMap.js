...
export default function ListingMap({ listing, compact = false }) {
    ...
    if (loading && (city || location)) {
      return (
        <section className="mb-12">
          ...
          <div className="relative w-full h-[350px] md:h-[450px] rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-slate-700 bg-slate-800 flex items-center justify-center">
  ...
  if (compact) {
    return (
      <div className="relative w-full h-[300px] rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-slate-700 bg-slate-800">
        <Map
          mapLib={maplibregl}
          initialViewState={{
            latitude: coords.lat,
        ...
        >
          ...
          {coords && (
            <Marker latitude={coords.lat} longitude={coords.lng} anchor="bottom"
              onClick={(e) => { e.originalEvent.stopPropagation(); setShowPopup(prev => !prev); }}>
              <div className="relative group cursor-pointer">
                ...
                <div className="relative bg-blue-600 text-white p-2 rounded-full shadow-xl border-2 border-white dark:border-slate-800 z-10">
          ...
          {coords && showPopup && (
            <Popup latitude={coords.lat} longitude={coords.lng} anchor="bottom" offset={[0, -40]}
              closeButton={true} closeOnClick={false} onClose={() => setShowPopup(false)} className="listing-map-popup">
              <div className="p-3 min-w-[180px]">
                ...
                <a href={`https://www.google.com/maps/dir/?api=1&destination=${coords.lat},${coords.lng}`}
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs py-2 px-3 rounded-lg transition-colors no-underline shadow-sm">
                  Nawiguj
                </a>
              </div>
            </Popup>
        ...
        {(location || city) && (
          <div className="absolute bottom-3 left-3 right-3 z-10">
            <div className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm px-3 py-2 rounded-xl shadow-lg border border-gray-200 dark:border-slate-700 flex items-center gap-2">
  ...
  return (
    <section className="mb-12">
      ...
      <div className="relative w-full h-[350px] md:h-[450px] rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-slate-700 bg-slate-800">
        <Map
          mapLib={maplibregl}
          initialViewState={{
            latitude: coords.lat,
